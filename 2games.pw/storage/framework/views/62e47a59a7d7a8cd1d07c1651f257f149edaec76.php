        ...
        <div>
            <div>
                ...
                <div id="navbar-mobile">
                    ...
                    <div>
                        <button class="games__button button-register spin-gradient sign__up sign__up"><?php echo app('translator')->getFromJson('app.register'); ?></button>
                    ...
                    <div id="mobile-submenu">
                        ...
                        <img src="/assets/_new-style/images/left_chevron.png"/><?php echo app('translator')->getFromJson('app.back'); ?></span></a>
                    </div>
                </div>
                            ...
                            <img src="/assets/_new-style/images/logo.png" alt="logo"/>
                                ...
                                <li>
                                    <a href="#" class="games__button button-login sign__in" ng-click="openModal($event, '#login-modal')">
                                        <?php echo app('translator')->getFromJson('app.login'); ?>                                   </a>
                                </li>
                            </ul>
                                ...
                                <ul class="container">
                                    ...
                                    <li>
                                        <a class="games__button button-register spin-gradient sign__up" ng-click="openModal($event, '#registration-confirm')">
                                            <?php echo app('translator')->getFromJson('app.register'); ?>                                        </a>
                                    </li>
                                        <li>
