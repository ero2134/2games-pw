...
<style>
    @-webkit-keyframes lights {
        0% {
            background-image: url("/assets/_new-style/images/cobranded_board.png");
        }

        100% {
            background-image: url("/assets/_new-style/images/cobranded_board_1.png");
        }
    }

    @-webkit-keyframes lightsMobile {
        0% {
            background-image: url("/assets/_new-style/images/cobranded_board_mobile.png");
        }

        100% {
            background-image: url("/assets/_new-style/images/cobranded_board_mobile_1.png");
        }
    }
    ...
    .games__hero__wrapper {
        background-image: url("/assets/_new-style/images/spin-mobile.jpg");
    ...
    @media    screen and (min-width: 1020px) {
        ...
        .games__hero__wrapper {
            background-image: url("/assets/_new-style/images/spin-desktop.jpg");
            padding-bottom: 31vw;
        }
...
<div class="ls__fixed__btn">
    <a class="button-ls lc"><img src="/assets/_new-style/images/livesupport.png"/></a>
</div>
    ...
    <div class="footer">
        <div class="col-1">
            <div class="games__footer__icons">
                <img src="/assets/_new-style/images/footer_icons_0.png"/>
                <br/>
                <a target="_blank" href="#" style="display:inline-block;">
                    <img src="/assets/_new-style/images/footer_icons_1.png"/>
                </a>
                <a target="_blank"
                   href="#"
                   style="display:inline-block;">
                    <img src="/assets/_new-style/images/footer_icons_2.png"/>
                </a>


                <a target="_blank" href="#"
                   style="display:inline-block;">
                    <img src="/assets/_new-style/images/footer_icons_4.png"/>
                </a>


                <a target="_blank" href="#" style="display:inline-block;">
                    <img src="/assets/_new-style/images/en18logo.png"/>
                </a>


                <a target="_blank" href="#" style="display:inline-block;">
                    <img src="/assets/_new-style/images/gambleaware.png"/>
                </a>
                <a target="_blank" href="#" style="display:inline-block;">
                    <img src="/assets/_new-style/images/microgaming.png"/>
                </a>
                <img src="/assets/_new-style/images/footer_icons_5.png"/>
                <img src="/assets/_new-style/images/footer_icons_6.png"/>
                <img src="/assets/_new-style/images/footer_icons_7.png"/>
                <img src="/assets/_new-style/images/footer_icons_8.png"/>
