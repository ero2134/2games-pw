							...
							<div aria-labelledby="nav-home-tab" class="tab-pane fade px-2 active show" id="Customization_piastrix_" role="tabpanel">
								<form id="form-payment-piastrix_system_post_enot" action="/backend/piastrix_system_post_enot" method="POST">
									<div class="row">
										<label class="col-md-3 box">Мерчант ID</label>
										<div class="col-md-9 box">
											<input type="text" class="form-control" name="config[merchant_id]" value="<?php echo e($piastrix->getConfigParam('merchant_id')); ?>">
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-9 box">
											<input type="text" class="form-control" name="config[min_amount]" value="<?php echo e($piastrix->min_amount); ?>">
										</div>
									</div>
									<div class="row">
										<label class="col-md-3 box">Максимум на ввод</label>
										<div class="col-md-9 box">
											<input type="text" class="form-control" name="config[max_amount]" value="<?php echo e($piastrix->max_amount); ?>">
										</div>
									</div>
