<nav class="col-md-2 sidebar">
    ...
    <div class="sidebar-sticky">
        <ul class="nav flex-column">
			...
			<?php endif; ?>
			 <li class="nav-item">
                <a class="nav-link <?php echo e(Request::is('backend/code_system') ? 'active' : ''); ?>" href="<?php echo e(route('backend.code.system')); ?>">
					<i class="fas fa-server"></i>
                    <?php echo app('translator')->getFromJson('app.code_system'); ?>
                </a>
            </li>
			...
			<li class="nav-item">
			  ...
			  <li class="nav-item">
                <a href="#roles-dropdowngg" class="nav-link" data-toggle="collapse" aria-expanded="<?php echo e(Request::is('backend/bonus*') || Request::is('backend/bonus*') ? 'true' : 'false'); ?>">
                    <i class="fas fa-users-cog"></i>
                    <span><?php echo app('translator')->getFromJson('app.bonus'); ?></span>
                </a>
                <ul class="<?php echo e(Request::is('backend/bonus*') || Request::is('backend/bonus*') ? '' : 'collapse'); ?> list-unstyled sub-menu" id="roles-dropdowngg">
					
					<li class="nav-item">
                        <a class="nav-link <?php echo e(Request::is('backend/bonus/reg') ? 'active' : ''); ?>" href="/backend/bonus/reg"><?php echo app('translator')->getFromJson('app.bonus_reg'); ?></a>
                    </li>
					<li class="nav-item">
                        <a class="nav-link <?php echo e(Request::is('backend/bonus/dep') ? 'active' : ''); ?>" href="/backend/bonus/dep"><?php echo app('translator')->getFromJson('app.bonus_dep'); ?></a>
                    </li>
					<li class="nav-item">
                        <a class="nav-link <?php echo e(Request::is('backend/bonus/nondep') ? 'active' : ''); ?>" href="/backend/bonus/nondep"><?php echo app('translator')->getFromJson('app.bonus_nondep'); ?></a>
                    </li>					
           ...
           <!-- <li class="nav-item">
                        ...
                        <a class="nav-link <?php echo e(Request::is('backend/bots') ? 'active' : ''); ?>"
                           href="<?php echo e(route('backend.settings.bots')); ?>">
                            <?php echo app('translator')->getFromJson('app.bots'); ?>
					            ...
					            <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::is('backend/maill') ? 'active' : ''); ?>"
                           href="/backend/maill">
                            maill
                        </a>
                    </li>
			...
			<?php endif; ?>
            <li class="nav-item">
                <a class="nav-link <?php echo e(Request::is('backend/payment_system') ? 'active' : ''); ?>"
                   href="<?php echo e(route('backend.payment.system')); ?>">
                        <i class="fas fa-server"></i>
                        <?php echo app('translator')->getFromJson('app.payment_system'); ?>
                </a>
            </li>
        </ul>
    </div>
