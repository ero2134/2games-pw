<tr>
    ...
    <td class="align-middle"><?php echo e($user->email); ?></td>
	  <td class="align-middle">
		<span class="badge badge-success"><?php echo e($user->balance); ?></span>
		|
		<span class="badge badge-info"><?php echo e($user->wager); ?></span>
		|
		<span class="badge badge-lg badge-secondary"><?php echo e($user->wager_bonus); ?></span>
