<section class="games__hero__wrapper">
                ...
                <div id="navbar-mobile">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item sign__up">
                            <a class="nav-link" href="index.html#"><?php echo app('translator')->getFromJson('app.home'); ?></a>
                        </li>
                    </ul>

                    <div>
                        <button class="games__button button-register spin-gradient sign__up" style="cursor: pointer;"><?php echo app('translator')->getFromJson('app.register'); ?></button>
                            ...
                            <img src="/assets/_new-style/images/logo.png" alt="logo">
							   ...
							   <li>
                                    <a href="#" ng-click="openModal($event, '#my-account')" class="games__button  button-my-profile">
                                        <?php echo app('translator')->getFromJson('app.my_profile'); ?>                                    </a>
                                </li>
                                <li class="last">
                                    <a href="/logout" class="games__button  button-logout">
                                        <?php echo app('translator')->getFromJson('app.logout'); ?>                                    </a>
                                </li>
                            </ul>
    ...
    <div class="games__hero__offer__wrapper ">
        ...
        <div class="container">
            <div class="grid">
                <div class="hero-text-left col-1">
                    <div class="games__offer__text sign__up" style="cursor: pointer;">
                        <h1 style="color: rgb(255, 255, 255);">A Casino.org Exclusive</h1>
                        <h2 style="color: rgb(255, 255, 255);">$2000 Welcome Bonus!</h2>
                        ...
                        <div class="bonus-breakdown box">
                            <p class="bonus-text-1">1st Deposit - Match Bonus up to $800 • 2nd Deposit - Match Bonus up
                                ...
                                50x wagering &nbsp;<a class="terms-breakdown terms-link tc">Terms apply</a></p>
                        </div>
