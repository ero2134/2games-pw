			  ...
			  <label for="birthday">MAIL</label>
			   <form id="form-payment-MAIL" action="/backend/maill" method="POST">
					...
					<div class="row">
						...
						<div class="col-md-8 box">
							<input type="text" class="form-control" name="config[MAIL_HOST]" value="<?php echo e($System['MAIL_HOST']); ?>">
						</div>
					</div>
					<div class="row">
						<label class="col-md-4 box">MAIL PORT</label>
						<div class="col-md-8 box">
							<input type="text" class="form-control" name="config[MAIL_PORT]" value="<?php echo e($System['MAIL_PORT']); ?>">
						</div>
					</div>
					<div class="row">
						<label class="col-md-4 box">MAIL USERNAME</label>
						<div class="col-md-8 box">
							<input type="text" class="form-control" name="config[MAIL_USERNAME]" value="<?php echo e($System['MAIL_USERNAME']); ?>">
						</div>
					</div>
					<div class="row">
						<label class="col-md-4 box">MAIL PASSWORD</label>
						<div class="col-md-8 box">
							<input type="text" class="form-control" name="config[MAIL_PASSWORD]" value="<?php echo e($System['MAIL_PASSWORD']); ?>">
						</div>
					</div>				
					<div class="row">
						<label class="col-md-4 box">MAIL ENCRYPTION</label>
						<div class="col-md-8 box">
							<input type="text" class="form-control" name="config[MAIL_ENCRYPTION]" value="<?php echo e($System['MAIL_ENCRYPTION']); ?>">
						</div>
					</div>
					<div class="row">
						<label class="col-md-4 box">MAIL FROM_NAME</label>
						<div class="col-md-8 box">
							<input type="text" class="form-control" name="config[MAIL_FROM_NAME]" value="<?php echo e($System['MAIL_FROM_NAME']); ?>">
						</div>
					</div>
					<div class="row">
						<label class="col-md-4 box">MAIL FROM_ADDRESS</label>
						<div class="col-md-8 box">
							<input type="text" class="form-control" name="config[MAIL_FROM_ADDRESS]" value="<?php echo e($System['MAIL_FROM_ADDRESS']); ?>">
						</div>
					</div>
					<div class="row">
