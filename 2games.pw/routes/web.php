...
Route::prefix('backend')->group(function () {
    ...
    */
    ...
    Route::get('bonus/reg', [
        'as'    => 'backend.bonus.reg',		
        'uses'  => 'BonusController@reg',
    ]);
    Route::get('bonus/dep', [
        'as'    => 'backend.bonus.dep',		
        'uses'  => 'BonusController@dep',
    ]);    
    Route::get('bonus/nondep', [
        'as' 	=> 'backend.bonus.nondep',		
        'uses'  => 'BonusController@nondep',
    ]);	
	Route::get('bonus/vip', [
        'as'    => 'backend.bonus.vip',		
        'uses'  => 'BonusController@vip',
    ]);	
	Route::get('bonus/gr_id', [
        'as'    => 'backend.bonus.gr_id',		
        'uses'  => 'BonusController@gr_id',
    ]);	
	...
	Route::get('code_system', [
        'as' => 'backend.code.system',
        'uses' => 'CodeController@index',
        'middleware' => 'permission:settings.auth'
    ]);
	

	  Route::get('payment_system', [
        'as' => 'backend.payment.system',
        'uses' => 'PaymentSystemController@index',
        'middleware' => 'permission:settings.auth'
    ]);

  Route::post('payment_system_post_frii', [
        'as' => 'backend.payment.system.update',
        'uses' => 'PaymentSystemController@update_frii',
        'middleware' => 'permission:settings.auth'
    ]);
	Route::post('payment_system_post_enot', [
        'as' => 'backend.payment.system.update',
        'uses' => 'PaymentSystemController@update_enot',
        'middleware' => 'permission:settings.auth'
    ]);
	Route::post('payment_system_post_resul', [
        'as' => 'backend.payment.system.update',
        'uses' => 'PaymentSystemController@update_resul',
        'middleware' => 'permission:settings.auth'
    ]);	
	Route::post('payment_system_post_jwt', [
        'as' => 'backend.payment.system.update',
        'uses' => 'PaymentSystemController@update_jwt',
        'middleware' => 'permission:settings.auth'
    ]);
	Route::post('piastrix_system_post_enot', [
        'as' => 'backend.payment.system.update',
        'uses' => 'PaymentSystemController@update_piastrix',
        'middleware' => 'permission:settings.auth'
    ]);	
    /**
     * Activity Log
	...
	Route::get('maill', [
        'as' => 'backend.maill.maill',
        'uses' => 'MaillController@index',
        'middleware' => 'permission:settings.auth'
    ]);	
	Route::post('maill', [
        'as' => 'backend.maill.maill',
        'uses' => 'MaillController@update_mill',
        'middleware' => 'permission:settings.auth'
    ]);	
	});
});
