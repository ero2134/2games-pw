			...
			<div class="registration-wrap">
				<div class="registration-left">
					<div class="registration-box">
						...
						<h1 class="title center"> @lang('app.register')</h1>
						<form action="/register" method="post"  id="registrition">
							<input type="hidden" value="<?= csrf_token() ?>" name="_token">
							<div class="form-line">
								<label class="label" for="register_email">@lang('app.email')</label>
							...
							<div class="form-line form-line_paswrd-padding">
								<label class="label" for="register_passwordPlain">@lang('app.password')</label>
								<span class="form-elem-wrap form-elem-inpt">
							...
							<div class="btn-box-center">
								<button class="btn btn-green auth-btn" data-submit="" type="submit"> @lang('app.register')</button>
