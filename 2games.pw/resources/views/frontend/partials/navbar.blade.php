...
<?php if(isset($_GET['verify_email'])):?>
 <div class="modal" id="restore-password-success" style="display: block;">
            <header class="modal__header">
                <div class="span modal__title">  @lang('app.mail_activ_title')</div>
                <span ng-click="closeModal($event)" class="modal__icon icon icon_cancel js-close-popup"></span>
            </header>
            <div class="modal__content">
                <div id="restore-password-success-text" class="modal-text">@lang('app.mail_activ_manage')</div>
            </div>
            <div class="popup__footer">
...
<?php if(isset($_GET['confirmEmail'])):?>
 <div class="modal" id="restore-password-success" style="display: block;">
            ...
            <div class="modal__content">
                <div id="restore-password-success-text" class="modal-text">@lang('app.mail_action_code')</div>
            </div>
            <div class="popup__footer">
...
<div class="col-1-8 ">
                <div class="game__category @if ($category->href == $current_cat) game-cat-active @endif" data-href="{{ route('frontend.game.list.category', $category->href) }}">
						...
						<div class="game__sub__cat__header">
							...
							@foreach ($category->inner as $inner)
								<li class="subnav__item">
									<a class="@if ($inner->href == $cat_level_2 && $category->href == $current_cat) game-cat-active @endif" 
