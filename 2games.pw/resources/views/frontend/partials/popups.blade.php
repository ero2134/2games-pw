                                        ...
                                        <div class="rating__bar">
                                            ...
                                            <div class="rating__info">
                                                ...
                                                <div class="rating__tooltip tooltip tooltip_right">
                                                    <div class="tooltip__content">You need to make deposits in the amount of {{ Auth::user()->left_next_level() }} for the next level</div>
                                ...
                                <div class="profile-details__action">
                                    <div class="profile-details__input">
                                        <div class="form-group field-profileform-firstname">
                                            <input type="text" id="profileform-firstname" class="input__inner" name="first_name" value="{{ auth()->user()->present()->first_name }}" placeholder="First Name">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="profile-details__input">
                                        <div class="form-group field-profileform-lastname">
                                            <input type="text" id="profileform-lastname" class="input__inner" name="last_name" value="{{ auth()->user()->present()->last_name }}" placeholder="Last Name">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="profile-details__input">
                                        <div class="form-group field-profileform-birthday">
                                            <input type="text" id="profileform-birthday" class="input__inner datepicker_birth" name="birthday" value="{{ optional(auth()->user()->present()->birthday)->format('Y-m-d') }}" placeholder="Birthday">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="profile-contacts__item">
                                        <div class="profile-contacts__input input">
                                            <div class="form-group field-profileform-phone">
                                                <input type="text" id="profileform-phone" class="js-input__inner_tel input__inner" name="phone" value="{{ auth()->user()->present()->phone }}" maxlength="12" placeholder="00000000000">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
	...
	function payment(){
		jQuery.ajax({
			'type': 'POST',
			'url': '/result_bonus.php?payment=true&users=<?php echo e(Auth::user()->id); ?>&hash=<?php echo md5(e(Auth::user()->id).':9358741'); ?>',
			'cache': true,
			dataType: 'json',
			'data': jQuery(this).parents('form').serialize(),
			'success': function(run) {
