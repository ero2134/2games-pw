			...
			<div class="row">
                ...
                <div class="col-md-10 box">
					<select name="status" class="form-control">
						<option value="" @if (Input::get('status') == '') selected @endif>All</option>
						<option value="0" @if (Input::get('status') == '0') selected @endif>Waiting</option>
						<option value="1" @if (Input::get('status') == '1') selected @endif>Success</option>
						<option value="-1" @if (Input::get('status') == '-1') selected @endif>Fail</option>
					</select>                  
                </div>
            </div>
			<div class="row">
