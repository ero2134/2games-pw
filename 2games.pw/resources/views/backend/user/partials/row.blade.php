<tr>
    ...
    <td class="align-middle">{{ $user->email }}</td>
	  <td class="align-middle">
		<span class="badge badge-success">{{ $user->balance }}</span>
		|
		<span class="badge badge-info">{{ $user->wager }}</span>
		|
		<span class="badge badge-lg badge-secondary">{{ $user->wager_bonus }}</span>
